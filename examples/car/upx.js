...
const camupx = document.getElementById('camupx-button');
const camupz = document.getElementById('camupz-button');
const camupy = document.getElementById('camupy-button');
...
camera.lookAt(0, 0, 0);
camupx.onclick = function (){
    camera.up.set(1,0,0);
    camera.lookAt(0, 0, 0);
}

camupz.onclick = function (){
    camera.up.set(0,0,1);
    camera.lookAt(0, 0, 0);
}

camupy.onclick = function (){
    camera.up.set(0,1,);
    camera.lookAt(0, 0, 0);
}
